...
const Home = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const _data = await axiosInstance.get(
        `/${channelId["Bus 1"]}/feeds.json?api_key=${process.env.NEXT_PUBLIC_API_KEY}`
      );
  ...
  }, [speed, busElement.current, channelId]);
                ...
                <LineChart data={values[0]}>
                  ...
                  <YAxis
                    ...
                    label={{
                      value: `${
                        data.channel[
                          `field${1}` as keyof typeof data.channel
                        ]
                          .toString()[0]
                          .toUpperCase() +
                        data.channel[
                ...
                <LineChart data={values[1]}>
                  ...
                  <YAxis
                    ...
                    label={{
                      value: `${
                        data.channel[
                          `field${2}` as keyof typeof data.channel
                        ]
                          .toString()[0]
                          .toUpperCase() +
                        data.channel[
                ...
                <LineChart data={values[2]}>
                  ...
                  <YAxis
                    ...
                    label={{
                      value: `${
                        data.channel[
                          `field${3}` as keyof typeof data.channel
                        ]
                          .toString()[0]
                          .toUpperCase() +
                        data.channel[
